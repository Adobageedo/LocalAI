...
class Retriever(BaseRetriever):
    def __init__(self):
        ...
        embedder_instance = EMBEDDER_REGISTRY[retrieval_cfg.get("embedder", "huggingface")]()
        ...
        self.vectorstore = QdrantVectorStore(
            ...
            embedding=self.embedder._embedder,  # Pass the underlying LangChain embeddings object
        )
