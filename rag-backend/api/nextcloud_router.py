...
async def ingest_directory(
    ...
    try:
        ...
        logger.info(f"Ingestion du répertoire Nextcloud: {ingest_request.path} (max files: {ingest_request.max_files}, force: {ingest_request.force_reingest}, user: {user_id})")
