...
def get_supported_extensions():
    ...
    try:
        ...
        # Google Docs
        if 'gdoc' in supported_types:
            supported_extensions.add('.gdoc')
        if 'gsheet' in supported_types:
            supported_extensions.add('.gsheet')
        if 'gslides' in supported_types:
            supported_extensions.add('.gslides')
