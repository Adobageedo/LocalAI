...
AS $$
DECLARE
  project_url TEXT := 'https://wdkmjlwuqsvnlsfzdlcf.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indka21qbHd1cXN2bmxzZnpkbGNmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTMwNzIwNCwiZXhwIjoyMDYwODgzMjA0fQ.3Vr9n_52vTZ15JyAGfnqvMMLV3YGS1iX75nIx9O2rhc'; -- full access needed for http request to storage
