...
import msal
from backend.services.auth.credentials_manager import (save_microsoft_token, load_microsoft_token,
                               check_microsoft_credentials, delete_microsoft_token)
# Configuration
from backend.core.config import OUTLOOK_CLIENT_ID,OUTLOOK_TOKEN_PATH, OUTLOOK_SCOPES, ONEDRIVE_SCOPES, OUTLOOK_CALENDAR_SCOPES
...
logger = log.bind(name="backend.api.gmail.auth")
