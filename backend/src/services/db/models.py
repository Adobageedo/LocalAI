...
class ToneProfile:
    """Model class for tone_profiles table"""
    ...
    def create(cls, user_id: str, provider: str, style_analysis: str, email_count: int,
               analysis_date: Optional[datetime] = None) -> 'ToneProfile':
    ...
    @classmethod
    def get_by_user_and_provider(cls, user_id: str, provider: str) -> Optional['ToneProfile']:
    ...
    @classmethod
    def get_by_user_id(cls, user_id: str) -> List['ToneProfile']:
    ...
    @classmethod
    def get_all(cls) -> List['ToneProfile']:
