...
def load_and_split_document(filepath: str, metadata: Dict[str, Any], chunk_size: int = 1000, chunk_overlap: int = 100) -> List[str]:
...
def batch_load_and_split_document(filepaths: List[dict], chunk_size: int = 1000, chunk_overlap: int = 100) -> List[str]:
    """
