                  ...
                  {Object.values(fileSummary).map((file, index) => (
                    <div key={index}>
                      ...
                      {fileItems
                        ...
                        .map((fileItem, index) => {
                          // Extract URL from content if it contains a markdown link
                          // This is a workaround since we're displaying the URL in the markdown content
                          // but not storing it directly in the fileItem object
                          const linkMatch = fileItem.content.match(/\[.*?\]\((.*?)\)/);
                            ...
                            <div
                              ...
                              onClick={() => {
                                if (url) {
                                  ...
                                  // Otherwise show the file preview
                              ...
                              <div className="text-sm font-normal">
                                ...
                                {url ? (
                                  <span className="text-blue-600 hover:underline">
                                    {fileItem.content.replace(/\[.*?\]\(.*?\)/, match => {
                                      // Extract just the link text from markdown link
