    ...
    <div className="flex w-full flex-1 flex-col justify-center gap-2 px-8 sm:max-w-md">
      ...
      >
        ...
        <div className="flex mb-3 gap-2">
          ...
          <Input
            className="rounded-md border bg-inherit px-4 py-2 flex-1"
            name="phone"
            type="tel"
        ...
        {error && (
          <div className="bg-red-500/10 text-red-500 flex items-center gap-2 p-3 rounded-md mt-2">
        ...
        {success && (
          <div className="bg-green-500/10 text-green-500 flex items-center gap-2 p-3 rounded-md mt-2">
            <IconCheck size={18} />
